      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-3/5 text-center md:text-left z-20">
            ...
            >
                ...
                <span className="text-accent-500 text-xs font-bold tracking-[0.2em] uppercase">Trusted by 350+ Clients</span>
            </motion.div>
            ...
            >
                MASTER<br/>
                <span className="text-stroke hover:text-white transition-colors duration-500">YOUR</span><br/>
                SPACE.
            </motion.h1>
            ...
            >
                {TAGLINE}. Elevating properties across Gauteng with precision engineering and artisanal craftsmanship.
            </motion.p>
        ...
        >
            <div className="absolute top-10 right-0 w-64 h-80 rounded-2xl overflow-hidden border border-white/10 shadow-2xl rotate-3 z-10">
                <img src={HERO_IMAGES[0]} alt="Worker" className="w-full h-full object-cover opacity-80" />
            ...
            >
                <img src={HERO_IMAGES[1]} alt="Interior" className="w-full h-full object-cover opacity-60 grayscale hover:grayscale-0 transition-all duration-700" />
            </motion.div>
            ...
            >
                <div className="text-accent-500 font-display font-bold text-4xl">10+</div>
                <div className="text-white text-xs tracking-wider">YEARS OF<br/>EXCELLENCE</div>
            </motion.div>
        </motion.div>
      </div>
